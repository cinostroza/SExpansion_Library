...
public class II_SExp_sl2_S770 {
	...
	public static void main(String[] args) {
		...
		System.out.println("");
		System.out.println("This is the output of the example program II_SExp_sl2_S770.java, ");
		System.out.println("which performs expansions of the sl(2) algebra with the ");
		System.out.println("semigroup S_{5}^{770}, whose multiplication table is given by:");
