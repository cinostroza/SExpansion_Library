...
public class II_SExpStructConst_sl2_S770 {
	...
	public static void main(String[] args) {
		...
		System.out.println("");
		System.out.println("This is the output of the example program II_SExpStructConst_sl2_S770.java. ");
		...
		System.out.println("with the semigroup S_{5}^{770}, whose multiplication table is given by:");
		System.out.println("1 1 1 1 1");
		System.out.println("1 2 1 1 5");
		System.out.println("1 1 3 4 1");
		System.out.println("1 1 4 3 1");
		...
		// Then, we load the semigroup S_{5}^{770} and its resonant decomposition
		int [][] mS770 = {{1,1,1,1,1},{1,2,1,1,5},{1,1,3,4,1},{1,1,4,3,1},{1,5,1,1,2}};
	    ...
	    StructureConstantSetExpanded Gexp = S770.getExpandedStructureConstant( sl2 );
	    Gexp.showPretty();
		System.out.println("");
		System.out.println("-------------------");
		System.out.println("");
	    ...
	    // 3) the reduced algebra 
	    StructureConstantSetExpandedReduced RedGexp = new StructureConstantSetExpandedReduced( S770.getExpandedStructureConstant(sl2).data , 1);
	    RedGexp.showPretty();
	    System.out.println("");
	    System.out.println("-------------------");
		System.out.println("");
