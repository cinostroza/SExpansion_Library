...
public class II_SExp_sl2_S990 {
	...
	public static void main(String[] args) {
		...
		System.out.println("");
		System.out.println("This is the output of the example program II_SExp_sl2_S990.java, ");
		System.out.println("which performs expansions of the sl(2) algebra with the ");
		System.out.println("semigroup S_{5}^{990}, whose multiplication table is given by:");
		...
		System.out.println("S0 = {1,2,5}, S1 = {1,3,4} and zero element is 1.");
		System.out.println("");
