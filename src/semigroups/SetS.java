...
//    	System.out.println(" elements");
	...
	public static void main(String[] args) {
		int[] list = {1,2};
		System.out.println("Provant la classe SetS");
		SetS setS = new SetS( list);
		setS.show();
		SetS newSet = setS.eraseElement(0);
		newSet.show();
		setS.show();
		setS = newSet.addElement(4);
		setS.show();
		SetS [] result = setS.SubSets(1);
		...
		int [] list2 = { 1,2} ;
		SetS mySet = new SetS(list2 );
		SetS [] result2 = mySet.SubSets(2);
		System.out.println("A mostrar els resultats x a 4");
		System.out.println(result2.length);
		for ( i = 0 ; i < result2.length ; ++i ) {
			System.out.println("Subconjunt:") ;
			SetS.sort(result2[i]).show();
		}
		...
		SetS s1 = new SetS(i1);
		SetS s2 = new SetS(i2);
		System.out.println("Plenen l'espai s1 i s2?");
		System.out.println(SetS.fillTheSpace(s1, s2, 4));
	...
	SetS [] PermutationsAux( SetS original, SetS resultat ) {
		int i , j;
