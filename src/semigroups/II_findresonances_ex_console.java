...
public class II_findresonances_ex_console {
	...
	if (rS_E2 != null) {
	System.out.println("The semigroup S_E2 has "+rS_E2.length+ " resonances:");
	...
	if (rS_K3 != null) {
	System.out.println("The semigroup S_K3 has "+rS_K3.length+ " resonances:");
	...
	if (rS_N1 != null) {
	System.out.println("The semigroup S_N1 has "+rS_N1.length+ " resonances:");
	...
	if (rS_N2 != null) {
	System.out.println("The semigroup S_N2 has "+rS_N2.length+ " resonances:");
	...
	if (rS_N3 != null) {
	System.out.println("The semigroup S_N3 has "+rS_N3.length+ " resonances:");
	...
	if (rS_S3 != null) {
	System.out.println("The semigroup S_S3 has "+rS_S3.length+ " resonances:");
	...
	if (rS_S2 != null) {
	System.out.println("The semigroup S_S2 has "+rS_S2.length+ " resonances:");
	...
	if (rS_M3 != null) {
	System.out.println("The semigroup S_M3 has "+rS_M3.length+ " resonances:");
	...
	if (rS_M4 != null) {
	System.out.println("The semigroup S_M4 has "+rS_M4.length+ " resonances:");
