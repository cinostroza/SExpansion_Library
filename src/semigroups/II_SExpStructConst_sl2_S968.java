...
public class II_SExpStructConst_sl2_S968 {
	...
	public static void main(String[] args) {
		...
		System.out.println("");
		System.out.println("This is the output of the example program II_SExpStructConst_sl2_S968.java. ");
		...
		System.out.println("with the semigroup S_{5}^{968}, whose multiplication table is given by:");
		System.out.println("1 1 1 1 1");
		System.out.println("1 2 2 4 4");
		System.out.println("1 2 3 4 5");
		System.out.println("1 4 4 2 2");
		...
		// Then, we load the semigroup S_{5}^{968} and its resonant decomposition
		int [][] mS968 = {{1,1,1,1,1},{1,2,2,4,4},{1,2,3,4,5},{1,4,4,2,2},{1,4,5,2,3}};
	    Semigroup S968 = new Semigroup(mS968) ;
	    int[] mS0 = {1,2,3} ;
	    ...
	    StructureConstantSetExpanded Gexp = S968.getExpandedStructureConstant( sl2 );
	    Gexp.showPretty();
		System.out.println("");
		System.out.println("-------------------");
		System.out.println("");
	    ...
	    StructureConstantSetExpandedReduced RedGexp = new StructureConstantSetExpandedReduced( S968.getExpandedStructureConstant(sl2).data , 1);
	    RedGexp.showPretty();
	    System.out.println("");
	    System.out.println("-------------------");
		System.out.println("");
