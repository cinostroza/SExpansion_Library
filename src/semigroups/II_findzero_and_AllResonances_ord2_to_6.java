...
public class II_findzero_and_AllResonances_ord2_to_6 {
	...
	private static String Filename = String.format("./Output_examples/Output_II_findzero_and_AllResonances_ord"+order +".txt") ;
	public static void main(String[] args) throws IOException {
		Semigroup [] SemigroupL = Semigroup.loadFromFile() ;
		Semigroup s ;
		SetS [][] Resonances;
		SetS S0, S1;
		int zeroelement ;
