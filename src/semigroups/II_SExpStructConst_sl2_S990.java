...
public class II_SExpStructConst_sl2_S990 {
	...
	public static void main(String[] args) {
		...
		System.out.println("");
		System.out.println("This is the output of the example program II_SExpStructConst_sl2_S990.java. ");
		...
		System.out.println("with the semigroup S_{5}^{990}, whose multiplication table is given by:");
		...
		System.out.println("S0 = {1,2,5}, S1 = {1,3,4},");
		...
		// Then, we load the semigroup S_{5}^{990} and its resonant decomposition
		int [][] mS990 = {{1,1,1,1,1},{1,2,3,4,5},{1,3,2,5,4},{1,4,5,2,3},{1,5,4,3,2}};
	    Semigroup S990 = new Semigroup(mS990) ;
	    int[] mS0 = {1,2,5} ;
	    ...
	    StructureConstantSetExpanded Gexp = S990.getExpandedStructureConstant( sl2 );
	    Gexp.showPretty();
		System.out.println("");
		System.out.println("-------------------");
		System.out.println("");
	    ...
	    StructureConstantSetExpandedReduced RedGexp = new StructureConstantSetExpandedReduced( S990.getExpandedStructureConstant(sl2).data , 1);
	    RedGexp.showPretty();
	    System.out.println("");
	    System.out.println("-------------------");
		System.out.println("");
