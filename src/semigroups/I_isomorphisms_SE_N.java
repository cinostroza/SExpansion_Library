...
public class I_isomorphisms_SE_N {
	...
	public static void main(String[] args) {
		...
		Semigroup[] lista = Semigroup.loadFromFile();
		int i,k ;
...
//		Semigroup SE5 = new Semigroup(mSE5) ;
		...
		//Semigroup [] permutations_SE5;
		//SetS [] p_SE5 = (new SetS(7)).AllPermutations();
		//		
		//for ( i = 0 ; i < lista.length ; ++i){
		//	if ( lista[i].order == 7  ) {
		//		if ( lista[i].isotest(SE5)[0]) {
		//			System.out.println("The semigroup #" + lista[i].ID);
		//			lista[i].show();
		//			System.out.println("is isomorphic to SE5.");
		//			System.out.println("****");
		//			permutations_SE5 = lista[i].Permute();
		//			for ( k = 0 ; k < permutations_SE5.length; ++k) {
		//				if ( permutations_SE5[k].isEqualTo(SE5)) {
		//						System.out.print( "A permutation that brings #" + lista[i].ID + " to SE5 is P#");
		//						System.out.println(k);
		//						p_SE5[k].show();
		//						System.out.println("and the permuted semigroup is ");
		//						permutations_SE5[k].show();
		//						System.out.println("which is exactly SE5.");
		//						System.out.println("----");
		//						
		//				}
		//			}	
